    ...
    public int validarAdmin(String usuario) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (rs.getString("tipo_usuario").equals("SuperUsuario")) {
                    return 1;
                } else if (rs.getString("tipo_usuario").equals("Administrador")) {
                    return 2;
                } else if (rs.getString("tipo_usuario").equals("EquipoDirectivo")) {
                    return 3;
