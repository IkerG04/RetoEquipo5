...
CREATE TABLE IF NOT EXISTS `gestoractividadesextraescolares`.`gruposparticipantes` (
  ...
  CONSTRAINT `fk_gruposparticipantes_grupos1`
    ...
    REFERENCES `gestoractividadesextraescolares`.`grupos` (`codigogrupo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `gestoractividadesextraescolares`.`alojamiento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestoractividadesextraescolares`.`alojamiento` (
  `id` INT NOT NULL,
  `nombre` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `gestoractividadesextraescolares`.`listaalojamientos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestoractividadesextraescolares`.`listaalojamientos` (
  ...
  INDEX `fk_listaalojamientos_solicitud1_idx` (`idsolicitud` ASC) VISIBLE,
  CONSTRAINT `fk_listaalojamientos_solicitud1`
    FOREIGN KEY (`idsolicitud`)
    REFERENCES `gestoractividadesextraescolares`.`solicitud` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_listaalojamientos_alojamiento1`
    FOREIGN KEY (`idalojamiento`)
    REFERENCES `gestoractividadesextraescolares`.`alojamiento` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
